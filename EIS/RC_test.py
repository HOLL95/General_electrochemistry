...
for k in [0, 10]:
    ...
    for i in range(0, len(frequencies)):
        ...
        RC_sim=time_domain(
                            circuit={"z0":"R0", "z1":{"p1":"R1", "p2":"C1"}}, 
                            potential_func="{0}*np.sin(2*math.pi*{1}*t)".format(param_list["d_E"], frequencies[i]),
                            params={"R0":10, "R1":2, "C1":1e-3})
        current, time, potential=RC_sim.simulate()

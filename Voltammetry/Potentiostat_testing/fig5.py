...
files=[ "FTACV_MONASH_CHECK-CELL_v2_ideal_capacitor_200_mV_export_cv_", "Gamry_ideal_200mV_120Hz.txt", "FTACV_IVIUM_CHECK-CELL_v2_ideal_capacitor_200_mV_fwd_export.txt"]#,"FTacV_ideal_capacitor_(no harmonics)_200_mV_cv_"]
desire="Timeseries"
...
for j in range(0, len(files)):
    ...
    num_periods=800#int(np.floor(time[-1]*get_max))

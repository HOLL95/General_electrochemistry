...
plots=[plt.subplots(len(concentrations), 2),plt.subplots(len(concentrations), 2)]
...
for i in range(0, len(concentrations)):
    ...
    for j in range(0, 2):
        ...
        for repeat in range(0, num_repeats):
            ...
            bode_axes.set_title(text)
            nyquist_axes.set_title(text)

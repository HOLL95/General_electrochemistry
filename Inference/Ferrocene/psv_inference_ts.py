...
param_list=[0.0001221774141290586, -0.014200792442503635, -0.0004999999961734931, 8.067578625333204e-05, 9.01596754941932, 3.801579338166167, 3.9515996317135267]

ferro.def_optim_list(["Cdl","CdlE1", "CdlE2", "CdlE3","omega","cap_phase","phase"])
test1=ferro.test_vals(param_list, "timeseries")
plt.plot(voltage_results, test1)
plt.plot(voltage_results, current_results, alpha=0.6)
plt.show()

...
sim2=ferro.i_nondim(ferro.test_vals(time_series_params_red, "timeseries"))
#plt.plot(sim), 
plot_args=dict(data_time_series=ferro.i_nondim(current_results),PSV_time_series=sim ,wiggled_time_series=sim2  ,hanning=True, plot_func=abs, )#xaxis=voltage_results, DC_component=True

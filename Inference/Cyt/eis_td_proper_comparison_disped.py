...
for scale in [0.25, 0.5, 0.9]:
    ...
    EIS().bode(lav_ec_vals, frequencies, ax=ax, twinx=twinx, label="scale="+str(scale), scatter=1, line=False)
    EIS().bode(td_vals, frequencies, ax=ax, twinx=twinx, label="scale="+str(scale))

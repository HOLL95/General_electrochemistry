...
for i in range(0, len(scan_names)):
    core_list=["E0_mean","E0_std", "k_0", "alpha","gamma", "SWV_constant", "SWV_linear", "SWV_squared", "SWV_cubed"]
    ...
    fig.savefig("MCMC/%s_%s_ph5_2D.png"%(extra_terms[j], scan_names[i]), dpi=300)